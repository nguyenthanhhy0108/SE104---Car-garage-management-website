...
//                                .anyRequest().permitAll()); //For testing
                        ...
                        .requestMatchers("/add-part").permitAll()
                        .requestMatchers("/add-part/**").permitAll()
                        .requestMatchers("/add-service").permitAll()
                        .requestMatchers("/add-service/**").permitAll()
                        .requestMatchers("/delete-part").permitAll()
                        .requestMatchers("/delete-part/**").permitAll()
                        .requestMatchers("/delete-brand").permitAll()
                        .requestMatchers("/delete-brand/**").permitAll()
                        .requestMatchers("/change-day-limit").permitAll()
                        .requestMatchers("/change-day-limit/**").permitAll()
                        .requestMatchers("/get-all-brands").permitAll()
                        .requestMatchers("/get-all-brands/**").permitAll()
                        .requestMatchers("/get-data-form5").permitAll()
                        .requestMatchers("/get-parts-form5/**").permitAll()
                        .requestMatchers("/get-parts-form5").permitAll()
                        .requestMatchers("/add-number-part/**").permitAll()
                        .requestMatchers("/add-number-part").permitAll()
